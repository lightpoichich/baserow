...
class Command(BaseCommand):
    help = (
        "Imports an exported JSON and optionally a ZIP file containing the file. The "
        "applications are added to the provided group id. Exports generated by the "
    ...
    def handle(self, *args, **options):
        ...
        with open(export_path, "r") as export_buffer:
            ...
            try:
                ...
                self.stdout.write(
                    f"The `{name}.zip` was not found. This could result in missing "
                    f"files."
                )
