...
export BASEROW_WEB_FRONTEND_STARTUP_COMMAND="${BASEROW_WEB_FRONTEND_STARTUP_COMMAND:-'nuxt-local'}"
export BASEROW_BACKEND_STARTUP_COMMAND="${BASEROW_BACKEND_STARTUP_COMMAND:-'gunicorn'}"
export BASEROW_BACKEND_WSGI_STARTUP_COMMAND="${BASEROW_BACKEND_WSGI_STARTUP_COMMAND:-'gunicorn-wsgi'}"
export BASEROW_CELERY_WORKER_STARTUP_COMMAND="${BASEROW_CELERY_WORKER_STARTUP_COMMAND:-'celery-worker'}"
export BASEROW_CELERY_EXPORT_WORKER_STARTUP_COMMAND="${BASEROW_CELERY_EXPORT_WORKER_STARTUP_COMMAND:-'celery-exportworker'}"
export BASEROW_CELERY_BEAT_STARTUP_COMMAND="${BASEROW_CELERY_BEAT_STARTUP_COMMAND:-'celery-beat'}"
