...
class ListTimelineRowsQueryParamsSerializer(serializers.Serializer):
...
class TimelineViewExampleResponseStackSerializer(serializers.Serializer):
...
def get_timeline_view_example_response_serializer():
    return type(
        "TimelineViewExampleResponseSerializer",
        (serializers.Serializer,),
        {
            "rows": serializers.DictField(
                child=TimelineViewExampleResponseStackSerializer(),
            ...
            "field_options": serializers.ListSerializer(
                child=TimelineViewFieldOptionsSerializer()
            ),
