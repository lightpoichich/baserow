  ...
  <form @submit.prevent="submit">
    ...
    <FormElement :error="fieldHasErrors('base_url')" class="control">
      ...
      <div class="control__elements">
        ...
        />
        <div v-if="v$.base_url.required.$invalid" class="error">
          {{ $t('error.requiredField') }}
        </div>
        <div v-if="v$.base_url.url.$invalid" class="error">
    ...
    <FormElement :error="fieldHasErrors('client_id')" class="control">
      ...
      <div class="control__elements">
        ...
        />
        <div v-if="v$.client_id.required.$invalid" class="error">
          {{ $t('error.requiredField') }}
        </div>
      </div>
    </FormElement>
    <FormElement :error="fieldHasErrors('secret')" class="control">
      ...
      <div class="control__elements">
        <input
          ...
          @blur="v$.secret.$touch()"
        />
        <div v-if="v$.secret.required.$invalid" class="error">
          {{ $t('error.requiredField') }}
        </div>
      </div>
    </FormElement>
